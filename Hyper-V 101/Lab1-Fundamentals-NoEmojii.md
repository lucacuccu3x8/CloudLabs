# Hyper-V 101 - Course
![Lab Guide](JPG/Lab%20Guide.png)

These labs accompany the **Sophos Hyper-v 101** course in the Sophos Absorb LMS.  

They are estimated to take **10 hours to complete**.

This course is designed for Sophos Engineers who are new to virtualization and Hyper-V, and equip you with fundamental knowledge and hands-on experience.

It does not need to be finished in one sitting, as it has a modular structure.
